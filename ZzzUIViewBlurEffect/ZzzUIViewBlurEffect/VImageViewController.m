...
//  ZzzUIViewBlurEffect
//
//  Created by zhouzezhou on 2018/7/20.
...
// 此方法须在TAGERTS -> Linked Framework and Libraries里导入系统的Accelerate.framework框架
...
- (void)viewDidLoad {
    ...
    self.title = @"vImage effect";
    [self.view setBackgroundColor:[UIColor whiteColor]];
    
    UIImage *blueImg = [self boxblurImage:[UIImage imageNamed:@"backImgPic"] withBlurNumber:1];
